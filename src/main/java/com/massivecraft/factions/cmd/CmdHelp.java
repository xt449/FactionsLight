...
public class CmdHelp extends FCommand {
	...
	public void perform(CommandContext context) {
		if(FactionsPlugin.getInstance().conf().commands().help().isUseOldHelp()) {
			...
			if(page < 0 || page >= helpPages.size()) {
				context.msg(Localization.COMMAND_HELP_404.format(String.valueOf(page)));
				return;
			}
		...
		if(page == null || page.isEmpty()) {
			context.msg(Localization.COMMAND_HELP_404.format(pageArg));
			return;
		}
	...
	public void updateHelp(CommandContext context) {
		...
		pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_NEXTCREATE.toString()));
		...
		pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_INVITATIONS.toString()));
		...
		pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_HOME.toString()));
		...
		if(Econ.isSetup() && FactionsPlugin.getInstance().conf().economy().isEnabled() && FactionsPlugin.getInstance().conf().economy().isBankEnabled()) {
			pageLines = new ArrayList<>();
			pageLines.add("");
			pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_BANK_1.toString()));
			pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_BANK_2.toString()));
			pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_BANK_3.toString()));
			pageLines.add("");
		...
		pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_PLAYERTITLES.toString()));
		helpPages.add(pageLines);
		...
		pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_OWNERSHIP_1.toString()));
		pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_OWNERSHIP_2.toString()));
		pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_OWNERSHIP_3.toString()));
		helpPages.add(pageLines);
		...
		pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_RELATIONS_1.toString()));
		pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_RELATIONS_2.toString()));
		pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_RELATIONS_3.toString()));
		pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_RELATIONS_4.toString()));
		helpPages.add(pageLines);

		pageLines = new ArrayList<>();
		pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_RELATIONS_5.toString()));
		pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_RELATIONS_6.toString()));
		pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_RELATIONS_7.toString()));
		pageLines.add(Localization.COMMAND_HELP_RELATIONS_8.toString());
		pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_RELATIONS_9.toString()));
		pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_RELATIONS_10.toString()));
		pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_RELATIONS_11.toString()));
		pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_RELATIONS_12.toString()));
		pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_RELATIONS_13.toString()));
		helpPages.add(pageLines);

		pageLines = new ArrayList<>();
		pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_PERMISSIONS_1.toString()));
		pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_PERMISSIONS_2.toString()));
		pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_PERMISSIONS_3.toString()));
		pageLines.add(Localization.COMMAND_HELP_PERMISSIONS_4.toString());
		pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_PERMISSIONS_5.toString()));
		pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_PERMISSIONS_6.toString()));
		pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_PERMISSIONS_7.toString()));
		pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_PERMISSIONS_8.toString()));
		pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_PERMISSIONS_9.toString()));
		helpPages.add(pageLines);

		pageLines = new ArrayList<>();
		pageLines.add(Localization.COMMAND_HELP_MOAR_1.toString());
		pageLines.add(FCmdRoot.getInstance().cmdBypass.getUsageTemplate(context, true));
		pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_ADMIN_1.toString()));
		pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_ADMIN_2.toString()));
		pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_ADMIN_3.toString()));
		...
		pageLines = new ArrayList<>();
		pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_MOAR_2.toString()));
		...
		pageLines = new ArrayList<>();
		pageLines.add(plugin.txt().parse(Localization.COMMAND_HELP_MOAR_3.toString()));
